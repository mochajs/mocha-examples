...
A standalone project showing TypeScript source files transpiled on-the-fly with [`--import tsx/esm`](https://tsx.is/node) as a Node ECMAScript Modules importer.
